...
##sometimes this chunk may take long time to run or report an error, if this happens then, please just re-open the Rstudio and try again
sentences <- sentences[, google.hits := GoogleHits(paste0("[", gsub("[,;!.]", "", speech), "] mlk"))]
```
